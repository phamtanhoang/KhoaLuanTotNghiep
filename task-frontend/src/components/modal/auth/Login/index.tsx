    ...
    <div className="sm:w-[30rem] w-screen p-8 bg-white sm:rounded-xl relative max-h-[90%]">
      ...
      <div className="mt-8">
          ...
          <div className="flex gap-5">
            ...
            <div className="flex ">
              <canvas
                ...
                width="130"
                height="40"
                className="border-2 border-indigo-500 rounded-l-lg border-r-0"
              ></canvas>
              <button
                className="text-xl p-2 rounded-r-lg bg-indigo-500 text-gray-100 hover:bg-indigo-600 cursor-pointer transition ease-in duration-300"
        ...
        <div>
          <button
            type="submit"
            className="mt-4 w-full flex justify-center bg-indigo-500 text-gray-100 p-3  rounded-full tracking-wide
        ...
        <p className="flex flex-col items-center justify-center mt-4 text-center text-md text-gray-500">
          <span>
            ...
            <a
              href="#"
              className="ml-1 text-indigo-500 hover:text-indigo-500no-underline hover:underline cursor-pointer transition ease-in duration-300"
            >
              Sign up
            </a>
          </span>
