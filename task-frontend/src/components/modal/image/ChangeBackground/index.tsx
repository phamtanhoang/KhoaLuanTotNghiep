...
const ChangeBackground: React.FC<{ handleClose: () => void }> = (props) => {
  ...
  return (
    <div className="w-full lg:w-[60%] max-lg:px-5 p-10 bg-white lg:rounded-xl max-h-[90vh] relative">
      <button
      ...
      <div className="text-center">
        <h2 className="text-3xl font-bold text-gray-900">Đổi ảnh bìa!</h2>
        <p className="mt-2 text-sm text-gray-400">
          Chọn ảnh bìa phù hợp tỉ lệ (3 : 1)
        </p>
      </div>
